...
cat "$LETTERS_FILE" | xargs -n 1 -P 100 -I {} bash -c 'get_subfolders "{}"'
...
cat "$SUBFOLDERS_FILE" | xargs -n 1 -P 100 -I {} bash -c 'get_packages "{}"'
...
cat "$URLS_FILE" | xargs -n 1 -P 100 -I {} bash -c 'process_package "{}"'
