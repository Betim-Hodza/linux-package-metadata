...
Works for Ubuntu, Debian, CentOS, Rocky, Fedora and Alpine mirrors.
"""
...
def scrape_all_links(base_url: str, max_depth: int = 10, distro: str = "generic") -> None:
    ...
    while not q.empty():
        ...
        # --------------------------------------------------------------
        # 1️⃣  If the URL itself is a package file → write it and skip fetching
        # --------------------------------------------------------------
        ...
        # --------------------------------------------------------------
        # 2️⃣  Fetch the page – but only if it looks like HTML
        # --------------------------------------------------------------
        try:
        ...
        # --------------------------------------------------------------
        # 3️⃣  Parse the HTML – be tolerant to odd markup
        # --------------------------------------------------------------
        try:
...
# ----------------------------------------------------------------------
# Main driver – loops over all distro URL groups
# ----------------------------------------------------------------------
def main():
    ...
    rocky_urls = [
        ...
        ROCKY_8_9_URL, ROCKY_8_10_URL, ROCKY_9_0_URL, ROCKY_9_1_URL,
